...
CREATE TABLE pedidos (
    ...
    CONSTRAINT pk_pedidos PRIMARY KEY (pedido_id), -- PK Simple por ahora
...
CREATE TABLE detalles_pedido (
    ...
    CONSTRAINT fk_detalles_pedido_pedido FOREIGN KEY (pedido_id) REFERENCES pedidos(pedido_id) ON DELETE CASCADE,
    CONSTRAINT fk_detalles_pedido_producto FOREIGN KEY (producto_id) REFERENCES productos(producto_id)
);
PROMPT Tabla DETALLES_PEDIDO creada.
...
CREATE TABLE pagos (
    ...
    CONSTRAINT uq_pagos_pedido UNIQUE (pedido_id),
    CONSTRAINT fk_pagos_pedido FOREIGN KEY (pedido_id) REFERENCES pedidos(pedido_id) ON DELETE CASCADE,
    CONSTRAINT chk_pagos_estado CHECK (estado_pago IN ('COMPLETADO', 'FALLIDO', 'REEMBOLSADO'))
);
PROMPT Tabla PAGOS creada.
